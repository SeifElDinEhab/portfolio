...
export function NextjsIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 128 128"
...
export function FramerMotionIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 41 14" width={size} height={size} {...props}>
      <defs>
        <clipPath id="framerClip">
      ...
      <circle cx="20.5" cy="7" r="7" fill="#FFDC5D" />
      <path
...
export function FramerIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="40 30 60 85"
