  ...
  return (
    <main className="font-inter relative">
      <Image
        ...
        width={3500}
        height={2500}
        className="w-full absolute z-0 opacity-15"
      />
      <div className="relative max-w-6xl mx-auto pt-40 flex flex-col items-center">
        <div className="flex items-center gap-3 text-5xl font-instrument">
          <h1>Hey there I am Seif</h1>
        ...
        <h3 className="text-lg font-medium text-[#5B5B5B] mt-8">
        ...
        <div className="mt-6">
          <Link
            href={"#work"}
            className="bg-white border rounded-full text-xs px-4 py-2"
          >
            View Work
          </Link>
        </div>
        ...
        <div className="absolute w-52 opacity-20 right-10 -bottom-48 rotate-12">
          <Image
            src={"/figma-logo.webp"}
            alt="vs code logo"
            width={100}
